...
.wrapper {
  ...
  &.level1 {
    background-image: url('/assets/comics/level1/1_4-6.png');
  }
  &.level2 {
    background-image: url('/assets/comics/level2/5_8-6.png');
  }
  &.level3 {
    background-image: url('/assets/comics/level3/9_11-6.png');
  }
}
