export default {
  ...
  patterns: {
    ...
    part4: ['Прогноз температуры ошибается в дождливые дни с севреным ветром или в солнечные дни с южным ветром', 'Прогноз температуры ошибается в солнечные дни с южным или восточным ветром или в дождливые дни с северным ветром', 'Прогноз температуры ошибается в солнечные дни с восточным ветром или в дождливые дни с западным ветром', 'Прогноз температуры ошибается только в солнечные дни с любым ветром'],
    part5: ['Прогноз температуры ошибается в любые дни с южным ветром', 'Прогноз температуры ошибается в солнечные дни с южным ветром и прогнозом теплой погоды или в любые доджливые дни', 'Прогноз температуры ошибается в солнечные дни с южным ветром или в дождливые дни с прогнозом холодной погоды', 'Прогноз температуры ошибается только в дождливые дни с любым ветром'],
  },
}