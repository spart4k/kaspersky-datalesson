...
export default {
  ...
  setup() {
    ...
    const onPaused = () => {
      if (level.value === '1' && timeout.value === 1) {
        timeout.value = 2
        messages.value.push(
      ...
      if (level.value === '1' && timeout.value === 2) {
        messages.value.push(
      ...
      if (level.value === '2' && timeout.value === 1) {
        timeout.value = 2
        messages.value.push(
      ...
      if (level.value === '2' && timeout.value === 2) {
        messages.value.push(
      ...
      if (level.value === '3' && timeout.value === 1) {
        timeout.value = 2
        messages.value.push(
      ...
      if (level.value === '3' && timeout.value === 2) {
        timeout.value = 3
        messages.value.push(
      ...
      if (level.value === '3' && timeout.value === 3) {
        timeout.value = 4
        messages.value.push(
      ...
      if (level.value === '3' && timeout.value === 4) {
        messages.value.push(
