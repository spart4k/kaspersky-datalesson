...
.wrapper {
  ...
  &.level1 {
    background-image: url('/assets/comics/level1/1_4-4.png');
  }
  &.level2 {
    background-image: url('/assets/comics/level2/5_8-4.png');
  }
  &.level3 {
    background-image: url('/assets/comics/level3/9_11-4.png');
  }
}
